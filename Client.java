...
public class Client
{
            ...
            } else
            {
                for (int i = 0; i < links.size(); i++)
                {
                    if (links.get(i).contains(clientChoice))
                    {
                        ...
                        DatagramPacket sendPacket = new DatagramPacket(sendData, sendData.length, InetAddress.getByName(IPADDRESS_LOCAL_DNS), PORT_LOCAL_DNS);
    ...
    public void getCDNFileTCP(String videoLink) throws IOException //HerCDNServer
    {
        ...
        String receivedFile = "src/ClientFiles/received" + fileRequestedNum + ".mp4";
